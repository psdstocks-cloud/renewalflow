    ...
    <div class="artly-reminder-grid artly-reminder-grid--summary">
      <div class="artly-reminder-card">
        ...
        <p class="artly-reminder-card__desc">
          <?php esc_html_e('Synced into RenewalFlow engine.', 'artly-reminder-bridge'); ?></p>
      </div>
      <div class="artly-reminder-card">
        ...
        <p class="artly-reminder-card__desc">
          <?php printf(esc_html__('Expected batches: %d', 'artly-reminder-bridge'), $expected_batches); ?></p>
      </div>
      <div class="artly-reminder-card">
        ...
        <p class="artly-reminder-card__desc">
          <?php esc_html_e('Latest Woo Points entry processed.', 'artly-reminder-bridge'); ?></p>
      </div>
      <div class="artly-reminder-card">
        ...
        <div class="artly-reminder-card__value">
          <?php echo esc_html($last_sync ? $last_sync : __('Never', 'artly-reminder-bridge')); ?></div>
        ...
        <div class="artly-reminder-card__header">
          <div>
            <div class="artly-reminder-card__title">
              <?php esc_html_e('Connection to RenewalFlow', 'artly-reminder-bridge'); ?></div>
            <p class="artly-reminder-card__desc">
        ...
        <form method="post" class="artly-reminder-manual-form">
          ...
          <div class="artly-reminder-manual-grid">
            <div class="artly-reminder-manual-item">
              <div class="artly-reminder-manual-text">
                ...
                <p><?php esc_html_e('Sync all WordPress users to the Reminder Engine.', 'artly-reminder-bridge'); ?>
                  ...
                  <?php esc_html_e('batches', 'artly-reminder-bridge'); ?>)</p>
              </div>
            ...
            <div class="artly-reminder-manual-item">
              <div class="artly-reminder-manual-text">
                <div class="artly-reminder-manual-title">
                  <?php esc_html_e('Sync Points Balances', 'artly-reminder-bridge'); ?></div>
            ...
            <div class="artly-reminder-manual-item">
              <div class="artly-reminder-manual-text">
                <div class="artly-reminder-manual-title">
                  <?php esc_html_e('Sync Charges / Orders', 'artly-reminder-bridge'); ?></div>
