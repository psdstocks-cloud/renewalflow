      ...
      <header className="pt-32 pb-24 px-6 text-center max-w-6xl mx-auto relative">
        ...
        <div className="relative z-10">
          ...
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-100">
            The AI-powered dashboard that tracks renewals, writes personalized point-rollover emails, and organizes your day—with secure authentication backed by Supabase.
          </p>
          <div className="flex flex-col md:flex-row justify-center gap-4 animate-fade-in-up animation-delay-200">
            ...
            <Link
              to="/auth/sign-in"
              className="px-8 py-4 bg-white text-gray-700 border border-gray-200 text-lg font-bold rounded-2xl hover:bg-gray-50 transition-all"
            >
              Log in
            </Link>
          </div>
          <p className="mt-6 text-sm text-gray-400 font-medium">
            <i className="fas fa-shield-alt mr-1"></i> Secure authentication • Email confirmed • JWT-protected API
          </p>
        </div>
      </header>
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden transform transition-transform hover:scale-[1.01]">
            ...
            {[{ name: 'Annual Cost', woo: '$249/year', flow: '$0 (Free)', highlight: true }, { name: 'Point Rollover Logic', woo: 'Complex Add-ons', flow: 'Built-in AI Logic', highlight: false }, { name: 'Email Personalization', woo: 'Generic Templates', flow: 'Gemini AI Writer', highlight: false }, { name: 'WhatsApp Reporting', woo: '$49 Plugin', flow: 'Built-in Daily Report', highlight: false }, { name: 'Setup Time', woo: 'Hours', flow: 'Instant', highlight: false }].map((row, idx) => (
